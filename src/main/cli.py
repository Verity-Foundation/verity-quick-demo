...
import middleware
from signer import sign, verify, Keys, CreateNew, Address
...
class AccountSession:
    ...
    def __init__(self, account_data: dict):
        ...
        self.address = Address(account_data) 
        self.private_key = Keys(account_data) 
...
class VerityDemoCLI:
    ...
    def handle_create_account(self):
        ...
        try:
            ...
            new_account = CreateNew() 
            address = Address(new_account)
            ...
            self.io.print(f"   Private key stored in session")
    ...
    def handle_create_diddoc(self): ## split into multiple components
        ...
        try:
            ...
            vm_type = self.io.input(f"Key type [Ed25519VerificationKey2020]: ").strip() or "Ed25519VerificationKey2020"
            ...
            self.io.print(f"\n{'✅ SUCCESS! ':=^50}")
            self.io.print(f"DID Document created:")
